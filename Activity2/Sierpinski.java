...
public class Sierpinski {
    ...
    public static void main(String[] args) {
        ...
        long blackTriangles = (long)Math.pow(3, level-1);
        System.out.println("Black: " + blackTriangles);
        long whiteTriangles =(blackTriangles - 1)/2;
        System.out.println("White: " + whiteTriangles);
